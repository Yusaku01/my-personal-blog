...
- Deployment: Cloudflare adapter (`@astrojs/cloudflare`) を使った `output: 'static'`
...
- スクリプト: `scripts/update-environment.js`, `scripts/build-ogp.js`, `scripts/perf/measure-fonts.mjs`
- テスト: `tests/`
- 静的アセット: `public/`
- ビルド成果物: `dist/`
- ドキュメント: `docs/`, `environment.md`
...
- 開発サーバー: `pnpm run dev`
- 事前同期: `pnpm run predev` (`environment.md` を更新)
- ビルド: `pnpm run build`
...
- 任意の API / フォーム設定: `QIITA_API_ENDPOINT`, `ZENN_API_ENDPOINT`, `PUBLIC_CONTACT_FORM_ENDPOINT`
- 分析 / reCAPTCHA: `PUBLIC_GOOGLE_ANALYTICS_ID`, `PUBLIC_GOOGLE_RECAPTCHA_SITE_KEY`
